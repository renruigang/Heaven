...
import com.renrg.heaven.model.MenuItem;
...
public class LeftMenuAdapter extends ArrayAdapter<MenuItem> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView iv = convertView.findViewById(R.id.id_item_icon);
        TextView title = convertView.findViewById(R.id.id_item_title);
...
//            convertView.setBackgroundColor(getContext().getResources().getColor(R.color.material_blue_500));
        }
